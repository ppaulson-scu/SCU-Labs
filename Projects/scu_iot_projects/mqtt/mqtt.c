...
#define MQTT_BROKER_ADDRESS "u-iot-coen-rpi-ppaulson"
#define WICED_TOPIC "light/led1"
#define CLIENT_ID "Peter Paulson"
...
static wiced_result_t wait_for_response(wiced_mqtt_event_type_t expected_event, uint32_t timeout )
    {
...
void application_start( void )
{
    ...
    do
    {
        ...
        wiced_rtos_delay_milliseconds( 100 );wiced_network_up( WICED_STA_INTERFACE, WICED_USE_EXTERNAL_DHCP_SERVER, NULL );
    }
